...
class RoutineSettingBasedOnMeal(QDialog):
    ...
    def initUI(self):
        ...
        self.routineSleepMorning = QCheckBox("아침", self)
        self.routineSleepMorning.move(100, 30)
        ...
        self.routineSleepNight = QCheckBox("점심", self)
        self.routineSleepNight.move(170, 30)
        ...
        self.routineSleepNight = QCheckBox("저녁", self)
        self.routineSleepNight.move(240, 30)
        self.routineSleepNight.resize(100, 80)
        # routineSleepNight.setChecked(False)
        self.routineSleepNight.stateChanged.connect(self.checkbox_toggled)
